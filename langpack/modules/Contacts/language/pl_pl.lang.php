...
$mod_strings = array (
    ...
    'LBL_OPPORTUNITY_ROLE'=>'Zależność w temacie',
    ...
    'LBL_PROSPECTS_LIST'=>'Lista potencjalnych klientów',
    ...
    'MSG_DUPLICATE' => 'Stworzenie tego kontaktu może spowodować utworzenie zduplikowanego kontaktu. Możesz wybrać kontakt z listy poniejż lub utworzyć kontakt klikając [Zapisz],z wykorzystaniem wprowadzonych danych, lub możesz kliknąć [Anuluj].',
    'MSG_SHOW_DUPLICATES' => 'Stworzenie tego kontaktu może spowodować utworzenie zduplikowanego kontaktu. \n Możesz wybrać kontakt z listy poniżej, utworzyć kontakt z wykorzystaniem wprowadzonych danych klikając [Zapisz], lub możesz kliknąć [Anuluj].',
    ...
    'LBL_PORTAL_DUPLICATE_USER_NAME' => 'Użyta nazwa portalu już istnieje. Wybierz inną nazwę portalu dla tego kontaktu.',
	'LBL_CHECKOUT_DATE'=>'Data zatwierdzenia',
    // BEGIN SUGARCRM DCE OMLY
    'LBL_CONTACT_DCEINST_FORM_TITLE' => 'Kontakt-instancja:',
    'LBL_DCEINST_NAME' => 'Nazwa instacnji:',
    'LBL_DCEINSTANCES' => 'Instancje',
    'LBL_DCEINSTANCE_ROLE' => 'Role instancji',
);
